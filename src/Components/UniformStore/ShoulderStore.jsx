...
const Shoulderstore = ()=>{
  ...
  const frontShoulderwide = `assets/jerseys/${jersyNum}/front-shoulders-wide.png`;
  const backshoulderwide = `assets/jerseys/${jersyNum}/back-shoulders-wide.png`;
  const frontShouldernarrow = `assets/jerseys/${jersyNum}/front-shoulders-narrow.png`;
  const backshouldernarrow = `assets/jerseys/${jersyNum}/back-shoulders-narrow.png`;
